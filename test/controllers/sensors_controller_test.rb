...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { active: @sensor.active, install_date: @sensor.install_date, location_id: @sensor.location_id, tagname: @sensor.tagname }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { active: @sensor.active, install_date: @sensor.install_date, location_id: @sensor.location_id, tagname: @sensor.tagname }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
