...
class ValuesControllerTest < ActionController::TestCase
  ...
  test "should create value" do
    assert_difference('Value.count') do
      post :create, value: { light: @value.light, sensor_id: @value.sensor_id, sound: @value.sound, temp: @value.temp }
    end
  ...
  test "should update value" do
    patch :update, id: @value, value: { light: @value.light, sensor_id: @value.sensor_id, sound: @value.sound, temp: @value.temp }
    assert_redirected_to value_path(assigns(:value))
  end
